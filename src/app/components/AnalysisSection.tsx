...
export const AnalysisSection = ({ activeTab, setActiveTab, weatherData, soilData, diseaseRisk }:
    { activeTab: string, setActiveTab: (arg: string) => void, weatherData: Weather[], soilData?: Soil, diseaseRisk?: Disease }) =>
